    ...
    <Content style={{ padding: '0 50px' }}>
      ...
      <Layout style={{ padding: '24px 0', background: '#fff' }}>
        ...
        <Content style={{ padding: '0 24px', minHeight: 500 }}>
          <img style={{width:"100%", height:500 ,opacity:0.7}} src="../../static/images/schedule.jpg" alt="ahihi"/>
            <div style={{ background:'white', padding: '20px 26px 100px 16px' }}>
                <Button style={{marginLeft:'30%', marginRight:'20%' }}type="primary" ghost><Link prefetch href="/scheduleMng/edit"><a>
                    Edit Schedule
                    </a></Link>
                </Button>
                <Button style={{width:150}}type="danger" ghost><Link prefetch href="/scheduleMng/view"><a>
                    View Schedule
                    </a></Link>
                </Button>
            </div>
