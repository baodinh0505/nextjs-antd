  ...
  float: "left"}}/>
    ...
    <Content style={{ padding: '0 50px' }}>
      ...
      <Layout style={{ padding: '24px 0', background: '#fff' }}>
        ...
        <img style={{width:"100%", height:500 ,opacity:0.7}} src="../../static/images/league.jpg" alt="ahihi"/>
            <div style={{ background:'white', padding: '20px 26px 100px 16px' }}>
                <Button style={{marginLeft:'30%', marginRight:'20%' }}type="primary" ghost><Link prefetch href="/teamMng/add"><a>
                    Add More Team
                    </a></Link>
                </Button>
                <Button style={{width:150,marginRight:'20%'}}type="danger" ghost><Link prefetch href="/teamMng/view"><a>
                    View
                    </a></Link>
                </Button>
            </div>
